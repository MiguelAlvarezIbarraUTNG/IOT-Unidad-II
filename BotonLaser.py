...
laser_pin = Pin(16, Pin.OUT)    # GPIO16 para el láser
boton_pin = Pin(4, Pin.IN)      # GPIO4 para el botón
...
MQTT_PORT = 1883
MQTT_TOPIC_SENSOR = "postgres/sensors"    # Publicar estado del botón
MQTT_TOPIC_ACTUATOR = "postgres/actuator" # Publicar estado del láser
...
while True:
    try:
        ...
        # Leer estado del botón
        estado_boton = boton_pin.value()

        # Encender o apagar el láser según el botón
        laser_pin.value(estado_boton)  # Si el botón es 1, el láser se enciende
    ...
    time.sleep(0.1)  # Pequeña pausa para estabilidad