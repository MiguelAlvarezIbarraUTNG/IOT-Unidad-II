...
# Configuración del sensor KY-021 (Mini Interruptor Magnético)
sensor = Pin(26, Pin.IN)  # Conectar la señal del KY-021 al pin 26
...
while True:
    try:
        ...
        if estado_actual != estado_anterior:
            if estado_actual == 1:
                mensaje = "CERRADO (IMÁN DETECTADO)"
            else:
                mensaje = "ABIERTO (SIN IMÁN)"
            
            print(f"[INFO] Sensor KY-021: {mensaje}")
